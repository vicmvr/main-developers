...
namespace Developers
{
    public class Ticket
    {
        ...
        public void PrintTicket(string impresora)
        {
            ...
            {
                //MessageBox.Show("No se ha detectado la impresora, Verifica el nombre correctamente", "FALTA IMPRESORA!!");
            }
        }
        ...
        private void DrawImage()
        {
            if (headerImage != null)
            {
                try
                {
                    gfx.DrawImage(headerImage, new Point((int)leftMargin+18, (int)YPosition()));
